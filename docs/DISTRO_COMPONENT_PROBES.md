...
browser download was not included in the evidence contract. Steam is now
admitted on its exact Ubuntu 24.04 multiarch target after the fresh full
artifact and parity review; MakeHuman remains an implementation gap.
