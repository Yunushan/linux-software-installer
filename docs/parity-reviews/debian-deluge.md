# Parity review: `debian/deluge`

## Scope and decision

- Evidence key: `debian/deluge`
...
- Verification report: `docs/evidence-verification/debian-deluge.json`

## Legacy rows covered

| Legacy ID | Immutable source locator | Legacy outcome | Decision for this row |
| --- | --- | --- | --- |
| `ubuntu-025` | `legacy/ubuntu-16.04/Ubuntu16-04-install-script.sh#menu:025` | Added the Deluge Team PPA, installed Deluge, and optionally wrote a user desktop entry. | `implemented` |

## Active replacement contract

- Supported target cells: `debian-12`, `ubuntu-24-04`, `ubuntu-26-04`
- Module and packages: `deluge`; distribution package `deluge`
...
| --- | --- | --- | --- |
| Package source/channel | Added the Deluge Team PPA. | Installs the distribution `deluge` package. | Retains the desktop BitTorrent-client capability without permanently changing APT trust or sources. |
...
The active module cleanly and repeatedly installs and verifies Deluge on every
declared current Debian-family target. The requested desktop BitTorrent-client
capability is retained without the legacy PPA or user-specific desktop-file
