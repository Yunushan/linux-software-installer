# Parity review: `debian/emacs`

## Scope and decision

- Evidence key: `debian/emacs`
...
- Verification report: `docs/evidence-verification/debian-emacs.json`

## Legacy rows covered

| Legacy ID | Immutable source locator | Legacy outcome | Decision for this row |
| --- | --- | --- | --- |
| `ubuntu-089` | `legacy/ubuntu-16.04/Ubuntu16-04-install-script.sh#menu:089` | Added the Kelley Emacs PPA, installed pinned `emacs26`, and optionally wrote a user desktop entry. | `implemented` |
...
| --- | --- | --- | --- |
| Package source/channel | Added a PPA and pinned Emacs 26. | Installs supported distribution `emacs`. | Retains editor capability without retaining an obsolete PPA and version pin. |
...
| Unsupported or unsafe legacy side effects | Added a PPA, a pinned unsupported version, and a hand-written launcher. | Does not add those side effects. | Removes persistent trust, obsolete pinning, and user-specific launcher mutation. |

## Reviewer conclusion

The active module cleanly and repeatedly installs and verifies Emacs on every
