# Parity review: `debian/musicbrainz-picard`

## Scope and decision

- Evidence key: `debian/musicbrainz-picard`
...
- Verification report: `docs/evidence-verification/debian-musicbrainz-picard.json`

## Legacy rows covered

| Legacy ID | Immutable source locator | Legacy outcome | Decision for this row |
| --- | --- | --- | --- |
| `ubuntu-060` | `legacy/ubuntu-16.04/Ubuntu16-04-install-script.sh#menu:060` | Added the MusicBrainz stable PPA, installed Picard, and optionally wrote a user desktop entry. | `implemented` |

## Active replacement contract

- Supported target cells: `debian-12`, `ubuntu-24-04`, `ubuntu-26-04`
- Module and packages: `musicbrainz-picard`; distribution package `picard`
- Package source and release channel: each target's configured signed distribution APT repositories; no PPA is added
- Verification binaries: `picard`
...
| --- | --- | --- | --- |
| Package source/channel | Added the MusicBrainz stable PPA. | Installs distribution `picard`. | Retains music-tagging capability without persistent third-party APT trust. |
...
The active module cleanly and repeatedly installs and verifies MusicBrainz
Picard on every declared current Debian-family target. `intent` parity is
accurate.
