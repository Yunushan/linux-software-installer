# Parity review: `debian/sayonara`

## Scope and decision

- Evidence key: `debian/sayonara`
...
- Verification report: `docs/evidence-verification/debian-sayonara.json`

## Legacy rows covered

| Legacy ID | Immutable source locator | Legacy outcome | Decision for this row |
| --- | --- | --- | --- |
| `ubuntu-055` | `legacy/ubuntu-16.04/Ubuntu16-04-install-script.sh#menu:055` | Added the Sayonara PPA, installed Sayonara, and optionally wrote a user desktop entry. | `implemented` |

## Active replacement contract

- Supported target cells: `debian-12`, `ubuntu-24-04`, `ubuntu-26-04`
- Module and packages: `sayonara`; distribution package `sayonara`
- Package source and release channel: each target's configured signed distribution APT repositories; no PPA is added
- Verification binaries: `sayonara`
...
| --- | --- | --- | --- |
| Package source/channel | Added the Sayonara PPA. | Installs distribution `sayonara`. | Retains the music-player capability without persistent third-party APT trust. |
...
The active module cleanly and repeatedly installs and verifies Sayonara on every
