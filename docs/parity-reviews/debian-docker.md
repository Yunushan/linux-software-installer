...
| --- | --- | --- |
| `ubuntu-066` | `legacy/ubuntu-16.04/Ubuntu16-04-install-script.sh#menu:066` | Removed existing Docker components, imported Docker's APT key, added its repository, and installed Docker CE. |
