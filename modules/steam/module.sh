...
MODULE_RISK='medium'
MODULE_NOTES='Requires explicit i386 multiarch acknowledgement; the packaged launcher is installed in /usr/games and game content/account sign-in remain Steam-managed.'
